...
<form class="form-horizontal" method="post" action="qupdate.php?id=<?php echo $_GET['id']?>"
...
<div class="form-group">
    ...
    <div class="col-md-4">
        <input type="text" id="creator" name="creator" placeholder="" class="form-co    ntrol input-md"  ?>
    </div>
</div>
<br/>
<div class="form-group">
    ...
    <div class="col-md-4">
        <input type=text id="x_coordinates" name="x_coordinates" placeholder="" class="form-control input-md"  ?>
    </div>
</div>
<br/>
<div class="form-group">
    ...
    <div class="col-md-4">
        <input type=text id="y_coordinates" name="y_coordinates" placeholder="" class="form-control input-md"  ?>
    </div>
</div>
<br/>
    <div class="form-group">
